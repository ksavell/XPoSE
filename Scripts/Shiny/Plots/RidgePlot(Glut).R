...
#By: Drake Thompson
#Date: Jun 2023
#Descript: Codes up the outputs for Ridge Plots for GLUTamatergic data
...
featVect <- glut@assays[["RNA"]]@counts@Dimnames[[1]]
...
#Finally makes plot
RidgePlot(glut, features = theFeat, group.by = theGroup)
