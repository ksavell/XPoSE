#' Title
#'
#' @param base_dir folder with all de results
#' @param pattern character vector of experimental and control, look at naming
#' within directory
#'
#' @returns
#' @export
#'
#' @examples
deg_overlap_and_venn <- function(base_dir, pattern) {
