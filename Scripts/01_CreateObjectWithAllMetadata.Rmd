...
setwd("/Users/savellke/Documents/Analysis/mm10_exp1") 
...
#'
#' @examples
create_seur <- function(count, cluster_no){
   assign(paste("data",".C",cluster_no,sep=""),CreateSeuratObject(counts = t(count), project = paste("C",cluster_no,sep="")))
}


refine_seur <- function(seur_obj, tag){
