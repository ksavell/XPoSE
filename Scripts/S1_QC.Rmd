...
top10.glut$gene <- paste0("<i>", top10.glut$gene, "</i>" )
```
#Create Heatmap
```{r}
pdf(file = "/Users/woodskad/Library/CloudStorage/Box-Box/mRFP-snSeq/Project1_XPoSEseq/XPoSEseq_manuscript/S1_panels/Heatmaps/glut_top10genes_heatmapV3.pdf",
    width = 10,
    height = 10)
...
theme(axis.title = element_blank(), axis.text.y = element_text(face = "italic", size = 10), axis.text.x = element_text(size = 10))
...
#Create Heatmap
```{r}
pdf(file = "/Users/woodskad/Library/CloudStorage/Box-Box/mRFP-snSeq/Project1_XPoSEseq/XPoSEseq_manuscript/S1_panels/Heatmaps/gaba_top10genes_heatmapV3.pdf",
    width = 10,
    height = 10)
