...
df.glut.CRS <- separate(df.glut.CRS, col = Var1, into = c("Cluster", "ratID", "Sex"), sep = "_")
...
```
#GABA: create Fraction/Percent Totals for Cluster_Sex_ratID for 
```{r}
...
df.gaba.CRS <- separate(df.gaba.CRS, col = Var1, into = c("Cluster", "ratID", "Sex"), sep = "_")
...
```{r}
write_csv(df.gaba.CRS, file = "/Users/woodskad/Library/CloudStorage/Box-Box/mRFP-snSeq/Project1_XPoSEseq/XPoSEseq_manuscript/S1_panels/Tables for S1 Panels/df.gaba.CRS.csv")
write_csv(df.glut.CRS, file = "/Users/woodskad/Library/CloudStorage/Box-Box/mRFP-snSeq/Project1_XPoSEseq/XPoSEseq_manuscript/S1_panels/Tables for S1 Panels/df.glut.CRS.csv")
