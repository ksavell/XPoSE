...
gaba2 <- subset(gaba2, idents = c("negative","positive"))
gaba3 <- subset(gaba3, idents = c("negative","positive"))
gaba4 <- subset(gaba4, idents = c("negative","positive"))
gaba5 <- subset(gaba5, idents = c("negative","positive"))
gaba6 <- subset(gaba6, idents = c("negative","positive"))
...
metadata <- read.csv("/Users/savellke/Documents/Analysis/mm10_exp1/March2023/metadataC.csv", row.names = 1)
