...
#UMAP Glut Subset. 
```{r}
pdf(file = "/Users/woodskad/Library/CloudStorage/Box-Box/mRFP-snSeq/Project1_XPoSEseq/XPoSEseq_manuscript/F2_panels/UMAPs w: AA colors/GlutUMAP.pdf",
    width = 10,
    height = 10)
DimPlot(glut.subset2, 
        group.by = "group", 
        cols = "#009999", "#00CC66", "#0080FF", "#0066CC", "#00994C" "#003366"
        shuffle = T) + 
  theme_void() + 
